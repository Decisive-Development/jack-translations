<section id="contact" class="bg-theme-gray py-32">
	<div class="container mx-auto px-6 md:px-12 lg:px-16">
		<!-- Main Heading -->
		<h2 class="text-center text-3xl font-bold  md:text-4xl">Get in Touch</h2>
		...
		<div class="mt-12 grid grid-cols-2 justify-center ">
			<div class="w-fit mx-auto">
				<div>
					<h3 class="mb-4 text-2xl font-semibold ">Contact Details</h3>
					<ul class="space-y-4 ">
						<li class="flex items-center">
							...
							<span
								>Email: <a href="mailto:your.email@example.com" class="text-blue-500"
						...
						<li class="flex items-center">
							...
							<span>Business Hours: Monday to Friday, 9 AM to 6 PM (CET)</span>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="w-fit mx-auto">
				<h3 class="mb-4 text-2xl font-semibold ">Connect with Me</h3>
				<ul class="space-y-4 ">
					...
					<li class="flex items-center">
						...
						<span
							><a href="https://www.linkedin.com" class="text-blue-500">LinkedIn Profile</a></span
						>
					</li>
					<li class="flex items-center">
						<svg
						...
						<span><a href="https://twitter.com" class="text-blue-500">Twitter</a></span>
					</li>
				</ul>
			</div>
		</div>
